...
$sql2 = "select f.nome, r.num_chave, c.descricao, r.turno from reserva r left join funcionario f
...
while($key_data = mysqli_fetch_assoc($resultado2)){
  if($key_data['num_chave']==$chave && $key_data['turno']==$turno){
    header("Location: erro.html");
    die();
  }
}
$sql = "insert into reserva values ('$turno', '$chave', '$matricula')";
