            ...
            <tbody>
              <?php
                while($user_data = mysqli_fetch_assoc($resultado)){
                  if($user_data['matricula'] == $_SESSION['user']){
                    echo "<tr>";
                    echo "<td>".$user_data['num_chave']."</td>";
                    echo "<td>".$user_data['descricao']."</td>";
                    echo "<td>".$user_data['turno']."</td>";
                    ?>
                    <a data-bs-toggle="modal" data-bs-target="#estetica"></a>
                    <?php
                    echo "<td><a href='deleteChave.php?num_chave=$user_data[num_chave]&turno=$user_data[turno]' class='btn btn-danger'>Devolver</a></td>";
                    echo "</tr>";
                  }
                }
              ?>
